...
class Inclusive_OpenId_Extension_AttributeExchange extends Zend_OpenId_Extension
{
    ...
    public function prepareRequest(&$params)
    {
    	...
    	// Set the name space
    	$params['openid.ns.ax'] = Inclusive_OpenId_Extension_AttributeExchange::NS_URL;
    ...
    public function parseResponse($params)
    {
    	...
    	if (isset($params['openid']['ns']['ax']) && $params['openid']['ns']['ax'] == Inclusive_OpenId_Extension_AttributeExchange::NS_URL)
    		$ax = $params['openid']['ax'];
    	else
    	{
    		...
    		foreach ($params['openid']['ns'] as $namespace => $uri)
    		{
    			...
    			if ($uri == Inclusive_OpenId_Extension_AttributeExchange::NS_URL)
    			{

 ...
 */
class Inclusive_OpenId_Extension_Ax extends Zend_OpenId_Extension
{
    /**
    ...
    public function prepareRequest(&$params)
    {
        ...
        if (is_array($this->_props) && count($this->_props) > 0) {
            ...
            $params['openid.ns.ax'] = Inclusive_OpenId_Extension_Ax::NAMESPACE_1_0;
            $params['openid.ax.mode'] = Inclusive_OpenId_Extension_Ax::MODE;
